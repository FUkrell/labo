...
PARAM$trainingstrategy$semilla_azar   <- 100003  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 100019  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
...
#Estas variables puede que tengan un drifting inmanejable por lo que se evitaran en prueba 3
...
rankear<- c('mcuenta_corriente','cdescubierto_preacordado','mcuentas_saldo','mcuentas_saldo')
