...
PARAM$finalmodel$max_bin           <-     81
PARAM$finalmodel$max_depth           <-     15
PARAM$finalmodel$learning_rate     <-      0.04458241   #0.0142501265
PARAM$finalmodel$num_iterations    <-    146  #615
PARAM$finalmodel$num_leaves        <-   401  #784
PARAM$finalmodel$min_data_in_leaf  <-   6985  #5628
PARAM$finalmodel$feature_fraction  <-      0.788616629  #0.8382482539
