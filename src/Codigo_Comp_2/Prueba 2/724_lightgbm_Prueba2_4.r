...
PARAM$finalmodel$max_bin           <-     39
PARAM$finalmodel$max_depth           <-     15
PARAM$finalmodel$learning_rate     <-      0.0197428596358294   #0.0142501265
PARAM$finalmodel$num_iterations    <-    190  #615
PARAM$finalmodel$num_leaves        <-   272  #784
PARAM$finalmodel$min_data_in_leaf  <-   2014  #5628
PARAM$finalmodel$feature_fraction  <-      0.776693244  #0.8382482539
