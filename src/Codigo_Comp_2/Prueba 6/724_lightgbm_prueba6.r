...
PARAM$finalmodel$learning_rate     <-      0.05094612
PARAM$finalmodel$num_iterations    <-    190
PARAM$finalmodel$num_leaves        <-   439
PARAM$finalmodel$min_data_in_leaf  <-   5328
PARAM$finalmodel$feature_fraction  <-     0.994834
