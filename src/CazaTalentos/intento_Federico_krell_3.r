...
Estrategia_B  <- function()
{
  ...
  #En cada ronda, los jugadores que participan, tiran diferentes cantidades de tiros
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 50 ]  #registro en la planilla que tiran 50 tiros
  resultado1  <- gimnasio_tirar( ids_juegan1, 50)
  planilla_cazatalentos[ ids_juegan1,  aciertos1 := resultado1 ]  #registro en la planilla


  #Ronda 2 -------------------------------------------------------
  #A la mitad mejor la hago tirar 50 tiros cada uno
  ...
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1-0.1 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan2,  tiros2 := 50 ]  #registro en la planilla que tiran 50 tiros
  ...
  #A la mitad mejor la hago tirar 50 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  mediana  <- planilla_cazatalentos[ ids_juegan2, median((aciertos2+aciertos1)) ]
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos2 -0.1>= mediana, id ]

  planilla_cazatalentos[ ids_juegan3,  tiros3 := 50 ]  #registro en la planilla que tiran 50 tiros
  resultado3  <- gimnasio_tirar( ids_juegan3, 50)
  planilla_cazatalentos[ ids_juegan3,  aciertos3 := resultado3 ]  #registro en la planilla


  #Ronda 4 -------------------------------------------------------
  #A la mitad mejor la hago tirar 45 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  mediana  <- planilla_cazatalentos[ ids_juegan3, median(aciertos3+aciertos2+aciertos1)) ]
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ aciertos3-0.1 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan4,  tiros4 := 50 ]  #registro en la planilla que tiran 50 tiros
  ...
  #A la mitad mejor la hago tirar 50 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  mediana  <- planilla_cazatalentos[ ids_juegan4, median((aciertos4+aciertos3+aciertos2+aciertos1)) ]
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ aciertos4 >= mediana, id ]

  planilla_cazatalentos[ ids_juegan5,  tiros5 := 200 ]  #registro en la planilla que tiran 50 tiros
  resultado5  <- gimnasio_tirar( ids_juegan5, 200)
  planilla_cazatalentos[ ids_juegan5,  aciertos5 := resultado5 ]  #registro en la planilla


  #Ronda 6 -------------------------------------------------------
  #A la mitad mejor la hago tirar 500 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  ...
  planilla_cazatalentos[ ids_juegan6,  tiros6 := 500 ]  #registro en la planilla que tiran 500 tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, 500)
  planilla_cazatalentos[ ids_juegan6,  aciertos6 := resultado6 ]  #registro en la planilla

  planilla_cazatalentos[ ids_juegan6,  aciertostot := aciertos1+aciertos2+aciertos3+aciertos4+aciertos5+aciertos6 ]


  #Epilogo
  #El cazatalentos toma una decision, elige al que mas aciertos tuvo en la ronda2
  pos_mejor <-  planilla_cazatalentos[ , which.max(aciertostot) ]
