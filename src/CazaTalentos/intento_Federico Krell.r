...
Estrategia_B  <- function()
{
  ...
  #En cada ronda, los jugadores que participan, tiran 50 tiros
  ...
  planilla_cazatalentos[ ids_juegan1,  tiros1 := 50 ]  #registro en la planilla que tiran 70 tiros
  ...
  ids_juegan2  <- planilla_cazatalentos[ ids_juegan1 ][ aciertos1 >= (mediana+1), id ]

  planilla_cazatalentos[ ids_juegan2,  tiros2 := 50 ]  #registro en la planilla que tiran 70 tiros
  ...
  ids_juegan3  <- planilla_cazatalentos[ ids_juegan2 ][ aciertos2 >= (mediana+1), id ]

  planilla_cazatalentos[ ids_juegan3,  tiros3 := 50 ]  #registro en la planilla que tiran 70 tiros
  ...
  ids_juegan4  <- planilla_cazatalentos[ ids_juegan3 ][ aciertos3 >= (mediana+1), id ]
  ...
  ids_juegan5  <- planilla_cazatalentos[ ids_juegan4 ][ aciertos4 >= (mediana+1), id ]
  ...
  #Ronda 6 -------------------------------------------------------
  #A la mitad mejor la hago tirar 300 tiros cada uno
  #La mediana siempre parte a un conjunto en dos partes de igual cantidad
  mediana  <- planilla_cazatalentos[ ids_juegan5, median(aciertos5) ]
  ids_juegan6  <- planilla_cazatalentos[ ids_juegan5 ][ aciertos5 >= (mediana+1), id ]

  planilla_cazatalentos[ ids_juegan6,  tiros6 := 300 ]  #registro en la planilla que tiran 200 tiros
  resultado6  <- gimnasio_tirar( ids_juegan6, 300)
