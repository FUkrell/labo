...
PARAM  <- list()
PARAM$experimento <- "TS9320_EC_RC_UM1"

PARAM$exp_input  <- "FE9250_EC_RC"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_EC_RC_UM1"

PARAM$exp_input  <- "TS9320_EC_RC_UM1"
# FIN Parametros del script
...
ksemilla  <- 102191 # aca poner una lista de las semilas??
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_EC_RC_UM1"
PARAM$exp_input  <- "HT9420_EC_RC_UM1"
