...
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_05"

PARAM$exp_input  <- "FE9250_bueno"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_05"

PARAM$exp_input  <- "FE9250_malo"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_2"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_3"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_4"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_6"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_bueno_8"
...
PARAM$train$sampling_total  <- 1.0  # 1.0 significa que NO se hace sampling total,  0.3 es quedarse con el 30% de TODOS los registros
PARAM$train$undersampling_mayoritaria  <- 0.8   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_2"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_3"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_4"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS932_malo_6"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "TS9320_malo_8"
