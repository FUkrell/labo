...
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_1"

PARAM$exp_input  <- "TS9320_bueno_1"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_2"

PARAM$exp_input  <- "TS9320_bueno_2"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_3"

PARAM$exp_input  <- "TS9320_bueno_3"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_4"

PARAM$exp_input  <- "TS9320_bueno_4"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_6"

PARAM$exp_input  <- "TS9320_bueno_6"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_8"

PARAM$exp_input  <- "TS9320_bueno_8"
# FIN Parametros del script
