...
PARAM  <- list()
PARAM$experimento <- "TS9320_ML_RC_UM5A"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_ML_RC_UM5A"

PARAM$exp_input  <- "TS9320_ML_RC_UM5A"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_ML_RC_UM5A"
PARAM$exp_input  <- "HT9420_ML_RC_UM5A"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_ML_RC_UM5B"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_ML_RC_UM5B"
PARAM$exp_input  <- "HT9420_ML_RC_UM5B"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_ML_RC_UM5C"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento  <- "ZZ9420_ML_RC_UM5C"
PARAM$exp_input  <- "HT9420_ML_RC_UM5C"
