...
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_05c"

PARAM$exp_input  <- "TS9320_bueno_05"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_05c"

PARAM$exp_input  <- "TS9320_malo_05"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_05d"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_05d"
