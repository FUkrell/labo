...
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_2c"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_bueno_3c"
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_1c"

PARAM$exp_input  <- "TS9320_malo_1"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_2c"

PARAM$exp_input  <- "TS9320_malo_2"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_3c"

PARAM$exp_input  <- "TS9320_malo_3"
# FIN Parametros del script
...
#Parametros del script
PARAM  <- list()
PARAM$experimento <- "HT9420_malo_4b"

PARAM$exp_input  <- "TS9320_malo_4"
# FIN Parametros del script
