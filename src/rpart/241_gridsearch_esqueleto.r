...
ksemillas  <- c(100003,100019,101021,101027,101051) #reemplazar por las propias semillas
...
{
 for( vcp  in  c( -1, 0, 0.001, 0.01, 0.1, 0.5, 1, 5)  )
 {for( vminbucket  in  c( 500, 400, 300, 200, 100, 50, 20, 10, 1 )  )
