...
# creo nuevas variables como suma de otras
...
dataset$mcaja_ahorro_total <- dataset$mcaja_ahorro + dataset$mcaja_ahorro_adicional  


# capacidad de ahorro, mayor a 1 es que gasta menos del saldo, menor a 1 es que gasta mas
