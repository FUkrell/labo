...
PARAM  <- list()
PARAM$experimento  <- "CA9080" # en la carpeta donde va
...
PARAM$final_train  <- c( 201906, 201907, 201908, 201909,  202008, 202009, 202010, 202107, 202108 )

PARAM$train$training     <- c(201906, 201907, 201908, 201909,  202008, 202009, 202010)
PARAM$train$validation   <- c( 202107 )
PARAM$train$testing      <- c( 202108 )
