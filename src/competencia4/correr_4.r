...
PARAM  <- list()
PARAM$experimento  <- "CA9090" # en la carpeta donde va
...
CanaritosAsesinos  <- function( canaritos_ratio=0.5 )
{
  gc()
  dataset[ , clase01:= ifelse( clase_ternaria=="CONTINUA", 0, 1 ) ]
...
PARAM$final_train  <- c( 201907,201908,201909, 202004,202005, 202102,
202104,202105,202106,202107)

PARAM$train$training     <- c(201907,201908,201909, 202004,202005, 202102,
202104,202105)
